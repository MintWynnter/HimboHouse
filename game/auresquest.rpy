...
label auresScene4:
    ...
    #voice au_puz4
    au "We would just need to find some teleportation method. Perhaps we could use a magic circle? This is a fairly old mansion. I am sure we have something like that."
    #voice au_puz3
...
label auresScene5:
    ...
    #voice auq4-22
    au "I am Aures Bellis, your future wife. We are in a mansion in the woods. You are now a ghost, so you are no longer fully opaque."
...
"End scene 6 kill path"
"Start scene 5 no kill path"
"Aures is holding tightly onto Minoru's arm, and he is subtly trying to get away from her."
#voice au_sad4
show aures neutral
au "Oh, wonderful, you're here! I was just about to go looking for you. We seem to have a slight issue."
